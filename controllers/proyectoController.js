...
const obtenerProyecto = async (req, res) => {
    ...
    try {
        ...
        res.status(404).json({msg: 'id que ingresaste no es válido'});
    }
...
const buscarColaborador = async (req, res) => {
    ...
    const usuario = await Usuario.findOne({email}).select('-password -createdAt -updatedAt -__v -token -confirmado');
    if(!usuario){
